...
namespace Pggo\InstititutionenModule\Block\Base;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties)
    {
        ...
        if (!$this->hasPermission('PggoInstititutionenModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        if (in_array($objectType, $this->categorisableObjectTypes)) {
            if ($featureActivationHelper->isEnabled(FeatureActivationHelper::CATEGORIES, $properties['objectType'])) {
                $categoryHelper = $this->get('pggo_instititutionen_module.category_helper');
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('PggoInstititutionenModule items');
        }
    ...
    {
        return 'Pggo\InstititutionenModule\Block\Form\Type\ItemListBlockType';
    }
    ...
    {
        return '@PggoInstititutionenModule/Block/itemlist_modify.html.twig';
    }
