...
namespace Pggo\InstititutionenModule\Twig\Base;
...
use Pggo\InstititutionenModule\Helper\WorkflowHelper;
...
abstract class AbstractTwigExtension extends Twig_Extension
{
    ...
    {
        return [
            new \Twig_SimpleFunction('pggoinstititutionenmodule_objectTypeSelector', [$this, 'getObjectTypeSelector']),
            new \Twig_SimpleFunction('pggoinstititutionenmodule_templateSelector', [$this, 'getTemplateSelector']),
            new \Twig_SimpleFunction('pggoinstititutionenmodule_userAvatar', [$this, 'getUserAvatar'], ['is_safe' => ['html']])
        ];
    }
    ...
    {
        return [
            new \Twig_SimpleFilter('pggoinstititutionenmodule_fileSize', [$this, 'getFileSize'], ['is_safe' => ['html']]),
            new \Twig_SimpleFilter('pggoinstititutionenmodule_listEntry', [$this, 'getListEntry']),
            new \Twig_SimpleFilter('pggoinstititutionenmodule_objectState', [$this, 'getObjectState'], ['is_safe' => ['html']])
        ];
    }
    
    /**
     * The pggoinstititutionenmodule_objectState filter displays the name of a given object's workflow state.
     * Examples:
     *    {{ item.workflowState|pggoinstititutionenmodule_objectState }}        {# with visual feedback #}
     *    {{ item.workflowState|pggoinstititutionenmodule_objectState(false) }} {# no ui feedback #}
     *
    ...
    /**
     * The pggoinstititutionenmodule_fileSize filter displays the size of a given file in a readable way.
     * Example:
     *     {{ 12345|pggoinstititutionenmodule_fileSize }}
     *
    ...
    /**
     * The pggoinstititutionenmodule_listEntry filter displays the name
     * or names for a given list item.
     * Example:
     *     {{ entity.listField|pggoinstititutionenmodule_listEntry('entityName', 'fieldName') }}
     *
    ...
    /**
     * The pggoinstititutionenmodule_objectTypeSelector function provides items for a dropdown selector.
     *
    ...
    /**
     * The pggoinstititutionenmodule_templateSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    public function getUserAvatar($uid = 0, $width = 0, $height = 0, $size = 0, $rating = '')
    {
        ...
        $view = \Zikula_View::getInstance('PggoInstititutionenModule');
