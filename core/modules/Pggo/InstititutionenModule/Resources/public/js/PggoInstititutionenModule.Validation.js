...
function pggoInstititutionenToday(format)
{
...
function pggoInstititutionenReadDate(val, includeTime)
{
...
function pggoInstititutionenValidateNoSpace(val)
{
    var valStr;
...
function pggoInstititutionenValidateUploadExtension(val, elem)
{
 ...
 */
function pggoInstititutionenExecuteCustomValidationConstraints(objectType, currentEntityId)
{
    jQuery('.validate-nospace').each( function() {
        if (!pggoInstititutionenValidateNoSpace(jQuery(this).val())) {
    ...
    jQuery('.validate-upload').each( function() {
        if (!pggoInstititutionenValidateUploadExtension(jQuery(this).val(), jQuery(this))) {
