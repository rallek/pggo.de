...
namespace Pggo\InstititutionenModule\Form\DataTransformer\Base;
...
use Pggo\InstititutionenModule\Form\Type\Field\UploadType;
use Pggo\InstititutionenModule\Helper\UploadHelper;
...
abstract class AbstractUploadFileTransformer implements DataTransformerInterface
{
    ...
    public function reverseTransform($data)
    {
        ...
        if (null === $uploadedFile) {
            // check files array
            $filesKey = 'pggoinstititutionenmodule_' . $objectType;
