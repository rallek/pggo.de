...
namespace Pggo\InstititutionenModule\Form\Handler\Common\Base;
...
abstract class AbstractEditHandler
{
     ...
     * @param InstititutionenFactory $entityFactory InstititutionenFactory service instance
    ...
    public function processForm(array $templateParameters)
    {
        ...
        if (null === $this->returnTo) {
            ...
            if ($this->request->getSession()->has('pggoinstititutionenmoduleReferer')) {
                $this->returnTo = $this->request->getSession()->get('pggoinstititutionenmoduleReferer');
            } elseif ($this->request->headers->has('pggoinstititutionenmoduleReferer')) {
                $this->returnTo = $this->request->headers->get('pggoinstititutionenmoduleReferer');
                $this->request->getSession()->set('pggoinstititutionenmoduleReferer', $this->returnTo);
        ...
        $this->permissionComponent = 'PggoInstititutionenModule:' . $this->objectTypeCapital . ':';
        ...
        if ($this->templateParameters['mode'] == 'edit') {
            ...
            if (null !== $entity) {
                if (true === $this->hasPageLockSupport && $this->kernel->isBundle('ZikulaPageLockModule') && null !== $this->lockingApi) {
                    ...
                    $lockName = 'PggoInstititutionenModule' . $this->objectTypeCapital . $this->createCompositeIdentifier();
        ...
        if (false === $actions || !is_array($actions)) {
            ...
            $logArgs = ['app' => 'PggoInstititutionenModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => $this->objectType, 'id' => $entity->createCompositeIdentifier()];
        ...
        if ($isRegularAction || $action == 'delete') {
            ...
            if ($entity->supportsHookSubscribers()) {
                ...
                if ($action != 'delete') {
                    ...
                    $url = new RouteUrl('pggoinstititutionenmodule_' . $this->objectType . '_display', $urlArgs);
                }
    ...
    protected function addDefaultMessage($args, $success = false)
    {
        ...
        $logArgs = ['app' => 'PggoInstititutionenModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => $this->objectType, 'id' => $this->entityRef->createCompositeIdentifier()];
        if (true === $success) {
    ...
    public function fetchInputData($args)
    {
        ...
        if (isset($this->form['additionalNotificationRemarks']) && $this->form['additionalNotificationRemarks']->getData() != '') {
            $this->request->getSession()->set('PggoInstititutionenModuleAdditionalNotificationRemarks', $this->form['additionalNotificationRemarks']->getData());
        }
