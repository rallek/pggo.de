 ...
 */
function PggoInstititutionenModule_operation_update(&$entity, $params)
{
    ...
    $logArgs = ['app' => 'PggoInstititutionenModule', 'user' => $container->get('zikula_users_module.current_user')->get('uname')];
