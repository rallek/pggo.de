...
abstract class AbstractImageHelper
{
    ...
    public function __construct(TranslatorInterface $translator, SessionInterface $session, VariableApi $variableApi)
    {
        ...
        $this->name = 'PggoInstititutionenModule';
    }
    ...
    public function getCustomRuntimeOptions($objectType = '', $fieldName = '', $contextName = '', $context = '', $args = [])
    {
        $options = [
            'thumbnail' => [
                ...
                'mode'      => $this->variableApi->get('PggoInstititutionenModule', 'thumbnailMode' . ucfirst($objectType) . ucfirst($fieldName), 'inset'),
        ...
        if ($contextName == $this->name . '_relateditem') {
            ...
            if (in_array($args['action'], ['view', 'display', 'edit'])) {
                ...
                $options['thumbnail']['size'] = [
                    $this->variableApi->get('PggoInstititutionenModule', 'thumbnailWidth' . $fieldSuffix, $defaultWidth),
                    $this->variableApi->get('PggoInstititutionenModule', 'thumbnailHeight' . $fieldSuffix, $defaultHeight)
                ];
            }
        }
