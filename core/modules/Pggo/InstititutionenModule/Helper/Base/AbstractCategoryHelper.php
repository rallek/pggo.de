...
abstract class AbstractCategoryHelper
{
    ...
    /**
     * Retrieves the main/default category of PggoInstititutionenModule.
     *
    ...
    public function getMainCat($objectType = '', $registry = '')
    {
        ...
        $logArgs = ['app' => 'PggoInstititutionenModule', 'user' => $this->currentUserApi->get('uname')];
        $this->logger->warning('{app}: User {user} called CategoryHelper#getMainCat which is deprecated.', $logArgs);
    
        return $this->categoryRegistryApi->getModuleCategoryId('PggoInstititutionenModule', ucfirst($objectType) . 'Entity', $registry, 32); // 32 == /__System/Modules/Global
    }
    ...
    public function retrieveCategoriesFromRequest($objectType = '', $source = 'POST')
    {
        ...
        $inputValues = null;
        $inputName = 'pggoinstititutionenmodule_' . strtolower($objectType) . 'quicknav';
        if (!$dataSource->has($inputName)) {
            $inputName = 'pggoinstititutionenmodule_' . strtolower($objectType) . 'finder';
        }
        if ($dataSource->has($inputName)) {
    ...
    public function getAllProperties($objectType = '')
    {
        ...
        return $this->categoryRegistryApi->getModuleRegistriesIds('PggoInstititutionenModule', ucfirst($objectType) . 'Entity');
    }
    ...
    public function getAllPropertiesWithMainCat($objectType = '', $arrayKey = '')
    {
        ...
        return $this->categoryRegistryApi->getModuleCategoryIds('PggoInstititutionenModule', ucfirst($objectType) . 'Entity', $arrayKey);
    }
    ...
    public function getMainCatForProperty($objectType = '', $property = '')
    {
        ...
        return $this->categoryRegistryApi->getModuleCategoryId('PggoInstititutionenModule', ucfirst($objectType) . 'Entity', $property);
    }
