...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function contentGetTypes(\Zikula_Event $event)
    {
        ...
        $types->add('PggoInstititutionenModule_ContentType_Item');
        
        // plugin for showing a list of multiple items
        $types->add('PggoInstititutionenModule_ContentType_ItemList');
    }
     ...
     * PggoInstititutionenModule will use this to add a javascript helper to add custom items.
     *
     * @param \Zikula_Event $event The event instance
     */
    public function getEditorHelpers(\Zikula_Event $event)
    {
        ...
        $helpers->add(
            [
                ...
                'type'   => 'javascript',
                'path'   => 'modules/Pggo/InstititutionenModule/Resources/public/js/PggoInstititutionenModule.Finder.js'
            ]
        );
    }
    ...
    public function getTinyMcePlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'pggoinstititutionenmodule',
                'path' => 'modules/Pggo/InstititutionenModule/Resources/docs/scribite/plugins/TinyMce/vendor/tinymce/plugins/pggoinstititutionenmodule/plugin.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'pggoinstititutionenmodule',
                'path' => 'modules/Pggo/InstititutionenModule/Resources/docs/scribite/plugins/CKEditor/vendor/ckeditor/plugins/pggoinstititutionenmodule/',
                'file' => 'plugin.js',
                'img'  => 'ed_pggoinstititutionenmodule.gif'
            ]
        );
    }
}
