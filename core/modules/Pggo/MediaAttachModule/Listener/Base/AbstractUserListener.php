...
abstract class AbstractUserListener implements EventSubscriberInterface
{
     ...
     * @return void
     */
    public function __construct(TranslatorInterface $translator, MediaAttachFactory $entityFactory, CurrentUserApi $currentUserApi, LoggerInterface $logger)
    {
    ...
    public function delete(GenericEvent $event)
    {
        ...
        $logArgs = ['app' => 'PggoMediaAttachModule', 'user' => $this->currentUserApi->get('uname'), 'entities' => 'files'];
