...
namespace Pggo\MediaAttachModule\Traits;
...
trait EntityWorkflowTrait
{
    ...
    {
        $entityClass = 'PggoMediaAttachModule:' . ucfirst($this->get_objectType()) . 'Entity';
    ...
    public function initWorkflow($forceLoading = false)
    {
        ...
        $workflowHelper = $container->get('pggo_mediaattach_module.workflow_helper');
        ...
        if (($loadingRequired && !$isReuse) || $forceLoading) {
            $result = Zikula_Workflow_Util::getWorkflowForObject($this, $objectType, $idColumn, 'PggoMediaAttachModule');
            if (!$result) {
    ...
    public function resetWorkflow()
    {
        ...
        $workflowHelper = ServiceUtil::get('pggo_mediaattach_module.workflow_helper');
