...
namespace Pggo\MediaAttachModule\Twig\Base;
...
use Pggo\MediaAttachModule\Helper\WorkflowHelper;
...
abstract class AbstractTwigExtension extends Twig_Extension
{
    ...
    {
        return [
            new \Twig_SimpleFunction('pggomediaattachmodule_objectTypeSelector', [$this, 'getObjectTypeSelector']),
            new \Twig_SimpleFunction('pggomediaattachmodule_templateSelector', [$this, 'getTemplateSelector']),
            new \Twig_SimpleFunction('pggomediaattachmodule_userAvatar', [$this, 'getUserAvatar'], ['is_safe' => ['html']])
        ];
    }
    ...
    {
        return [
            new \Twig_SimpleFilter('pggomediaattachmodule_fileSize', [$this, 'getFileSize'], ['is_safe' => ['html']]),
            new \Twig_SimpleFilter('pggomediaattachmodule_listEntry', [$this, 'getListEntry']),
            new \Twig_SimpleFilter('pggomediaattachmodule_objectState', [$this, 'getObjectState'], ['is_safe' => ['html']])
        ];
    }
    
    /**
     * The pggomediaattachmodule_objectState filter displays the name of a given object's workflow state.
     * Examples:
     *    {{ item.workflowState|pggomediaattachmodule_objectState }}        {# with visual feedback #}
     *    {{ item.workflowState|pggomediaattachmodule_objectState(false) }} {# no ui feedback #}
     *
    ...
    /**
     * The pggomediaattachmodule_fileSize filter displays the size of a given file in a readable way.
     * Example:
     *     {{ 12345|pggomediaattachmodule_fileSize }}
     *
    ...
    /**
     * The pggomediaattachmodule_listEntry filter displays the name
     * or names for a given list item.
     * Example:
     *     {{ entity.listField|pggomediaattachmodule_listEntry('entityName', 'fieldName') }}
     *
    ...
    /**
     * The pggomediaattachmodule_objectTypeSelector function provides items for a dropdown selector.
     *
    ...
    /**
     * The pggomediaattachmodule_templateSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    public function getUserAvatar($uid = 0, $width = 0, $height = 0, $size = 0, $rating = '')
    {
        ...
        $view = \Zikula_View::getInstance('PggoMediaAttachModule');
