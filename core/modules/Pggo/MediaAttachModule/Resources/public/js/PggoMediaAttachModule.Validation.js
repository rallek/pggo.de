...
function pggoMediaAttachToday(format)
{
...
function pggoMediaAttachReadDate(val, includeTime)
{
...
function pggoMediaAttachValidateNoSpace(val)
{
    var valStr;
...
function pggoMediaAttachValidateUploadExtension(val, elem)
{
 ...
 */
function pggoMediaAttachExecuteCustomValidationConstraints(objectType, currentEntityId)
{
    jQuery('.validate-nospace').each( function() {
        if (!pggoMediaAttachValidateNoSpace(jQuery(this).val())) {
    ...
    jQuery('.validate-upload').each( function() {
        if (!pggoMediaAttachValidateUploadExtension(jQuery(this).val(), jQuery(this))) {
