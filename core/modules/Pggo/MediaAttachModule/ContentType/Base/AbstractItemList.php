...
namespace Pggo\MediaAttachModule\ContentType\Base;
...
abstract class AbstractItemList extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('PggoMediaAttachModule list view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display list of PggoMediaAttachModule objects.');
    }
    ...
    {
        $controllerHelper = $this->container->get('pggo_mediaattach_module.controller_helper');
    ...
    {
        $repository = $this->container->get('pggo_mediaattach_module.entity_factory')->getRepository($this->objectType);
        ...
        $imageHelper = $this->container->get('pggo_mediaattach_module.image_helper');
    ...
    protected function getDisplayTemplate()
    {
        ...
        foreach ($templateOptions as $templatePath) {
            if ($templating->exists('@PggoMediaAttachModule/' . $templatePath)) {
                $template = '@PggoMediaAttachModule/' . $templatePath;
                break;
            }
        }
    ...
    protected function getSortParam($repository)
    {
        ...
        if ($this->sorting == 'newest') {
            $selectionHelper = $this->container->get('pggo_mediaattach_module.selection_helper');
