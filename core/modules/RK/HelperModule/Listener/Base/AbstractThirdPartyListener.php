...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function getTinyMcePlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rkhelpermodule',
                'path' => 'modules/RK/HelperModule/Resources/docs/scribite/plugins/TinyMce/vendor/tinymce/plugins/rkhelpermodule/plugin.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rkhelpermodule',
                'path' => 'modules/RK/HelperModule/Resources/docs/scribite/plugins/CKEditor/vendor/ckeditor/plugins/rkhelpermodule/',
                'file' => 'plugin.js',
