...
namespace RK\DownLoadModule\Traits;
...
trait EntityWorkflowTrait
{
    ...
    {
        $entityClass = 'RKDownLoadModule:' . ucfirst($this->get_objectType()) . 'Entity';
    ...
    public function resetWorkflow()
    {
        ...
        $workflowHelper = ServiceUtil::get('rk_download_module.workflow_helper');
