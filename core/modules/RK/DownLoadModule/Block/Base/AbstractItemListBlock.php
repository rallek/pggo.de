...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties)
    {
        ...
        if (!$this->hasPermission('RKDownLoadModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('RKDownLoadModule items');
        }
        ...
        $imageHelper = $this->get('rk_download_module.image_helper');
    ...
    {
        return 'RK\DownLoadModule\Block\Form\Type\ItemListBlockType';
    }
    ...
    {
        return '@RKDownLoadModule/Block/itemlist_modify.html.twig';
    }
