...
namespace RK\DownLoadModule\Form\Plugin\Base;
...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput implements ContainerAwareInterface
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            $jsAssetBag->add($assetHelper->resolve('@RKDownLoadModule:js/RKDownLoadModule.Finder.js'));
        ...
        if (!$permissionApi->hasPermission('RKDownLoadModule:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }

        $categorisableObjectTypes = ['file'];
        $catIds = [];
        ...
        $view = Zikula_View::getInstance('RKDownLoadModule', false);
    ...
    public function decode(Zikula_Form_View $view)
    {
        ...
        $this->objectType = $request->request->get('RKDownLoadModule_objecttype', 'file');
