...
namespace RK\TeamModule\Form\Handler\Person\Base;

use RK\TeamModule\Form\Handler\Common\EditHandler;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters)
    {
        ...
        if ($this->templateParameters['mode'] == 'create') {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                ...
                $logArgs = ['app' => 'RKTeamModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => $this->objectType];
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create('RK\TeamModule\Form\Type\PersonType', $this->entityRef, $options);
    }
    ...
    protected function getDefaultReturnUrl($args)
    {
        ...
        $routePrefix = 'rkteammodule_' . $this->objectTypeLower . '_' . $routeArea;
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'RKTeamModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'person', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
    ...
    protected function getRedirectUrl($args)
    {
        ...
        if ($this->request->getSession()->has('rkteammoduleReferer')) {
            $this->request->getSession()->del('rkteammoduleReferer');
        }
