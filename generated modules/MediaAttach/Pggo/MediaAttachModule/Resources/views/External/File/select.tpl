...
<p>
    ...
    <input type="button" id="pggoMediaAttachModuleSearchGo" name="gosearch" value="{gt text='Filter'}" class="btn btn-default" />
    <br{$break} />
</p>
<br />
<br />
...
/* <![CDATA[ */
    ( function($) {
        $(document).ready(function() {
            pggoMediaAttachModule.itemSelector.onLoad('{{$baseID}}', {{$selectedId|default:0}});
        });
    })(jQuery);
/* ]]> */
</script>
