...
abstract class AbstractLinkContainer implements LinkContainerInterface
{
    ...
    public function getLinks($type = LinkContainerInterface::TYPE_ADMIN)
    {
        ...
        if (LinkContainerInterface::TYPE_ACCOUNT == $type) {
            ...
            if (true === $this->variableApi->get('PggoMediaAttachModule', 'linkOwnFilesOnAccountPage', true)) {
                $objectType = 'file';
                if ($this->permissionApi->hasPermission($this->getBundleName() . ':' . ucfirst($objectType) . ':', '::', ACCESS_READ)) {
                    $links[] = [
                        'url' => $this->router->generate('pggomediaattachmodule_' . strtolower($objectType) . '_view', ['own' => 1]),
            ...
            if ($this->permissionApi->hasPermission($this->getBundleName() . '::', '::', ACCESS_ADMIN)) {
                $links[] = [
                    'url' => $this->router->generate('pggomediaattachmodule_file_adminindex'),
                    'text' => $this->__('Media attach Backend'),
                    'icon' => 'wrench'
                ];
            }
        ...
        if (LinkContainerInterface::TYPE_ADMIN == $type) {
            if ($this->permissionApi->hasPermission($this->getBundleName() . '::', '::', ACCESS_READ)) {
                $links[] = [
                    'url' => $this->router->generate('pggomediaattachmodule_file_index'),
        ...
        if (in_array('file', $allowedObjectTypes)
            ...
            $links[] = [
                'url' => $this->router->generate('pggomediaattachmodule_file_' . $routeArea . 'view'),
                'text' => $this->__('Files'),
        ...
        if ($routeArea == 'admin' && $this->permissionApi->hasPermission($this->getBundleName() . '::', '::', ACCESS_ADMIN)) {
            $links[] = [
                'url' => $this->router->generate('pggomediaattachmodule_config_config'),
