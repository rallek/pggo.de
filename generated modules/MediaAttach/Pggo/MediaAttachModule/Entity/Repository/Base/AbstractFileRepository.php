...
namespace Pggo\MediaAttachModule\Entity\Repository\Base;
...
abstract class AbstractFileRepository extends EntityRepository
{
    ...
    public function getAdditionalTemplateParameters(ImageHelper $imageHelper, $context = '', $args = [])
    {
        ...
        if ($context == 'controllerAction') {
            ...
            $objectType = 'file';
            $thumbRuntimeOptions = [];
            $thumbRuntimeOptions[$objectType . 'FileName'] = $imageHelper->getRuntimeOptions($objectType, 'fileName', $context, $args);
            ...
            if (in_array($args['action'], ['display', 'view'])) {
                ...
                $templateParameters['relationThumbRuntimeOptions'] = $imageHelper->getCustomRuntimeOptions('', '', 'PggoMediaAttachModule_relateditem', $context, $args);
            }
        }
    ...
    public function truncateTable(LoggerInterface $logger)
    {
        ...
        $qb->delete('Pggo\MediaAttachModule\Entity\FileEntity', 'tbl');
        $query = $qb->getQuery();
    
        $query->execute();
    
        $logArgs = ['app' => 'PggoMediaAttachModule', 'entity' => 'file'];
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApi $currentUserApi)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->update('Pggo\MediaAttachModule\Entity\FileEntity', 'tbl')
        ...
        $logArgs = ['app' => 'PggoMediaAttachModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'files', 'userid' => $userId];
    ...
    protected function getCountQuery($where = '', $useJoins = true)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->select($selection)
           ->from('Pggo\MediaAttachModule\Entity\FileEntity', 'tbl');
