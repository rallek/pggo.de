...
namespace Pggo\MediaAttachModule\Block\Base;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties)
    {
        ...
        if (!$this->hasPermission('PggoMediaAttachModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('PggoMediaAttachModule items');
        }
        ...
        $imageHelper = $this->get('pggo_mediaattach_module.image_helper');
    ...
    {
        return 'Pggo\MediaAttachModule\Block\Form\Type\ItemListBlockType';
    }
    ...
    {
        return '@PggoMediaAttachModule/Block/itemlist_modify.html.twig';
    }
