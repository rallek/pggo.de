 ...
 */
function PggoMediaAttachModule_operation_delete(&$entity, $params)
{
    ...
    $logArgs = ['app' => 'PggoMediaAttachModule', 'user' => $container->get('zikula_users_module.current_user')->get('uname')];
