...
namespace Pggo\MediaAttachModule\Form\Handler\File\Base;

use Pggo\MediaAttachModule\Form\Handler\Common\EditHandler;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters)
    {
        ...
        if ($this->templateParameters['mode'] == 'create') {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                ...
                $logArgs = ['app' => 'PggoMediaAttachModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => $this->objectType];
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create('Pggo\MediaAttachModule\Form\Type\FileType', $this->entityRef, $options);
    }
    ...
    protected function getDefaultReturnUrl($args)
    {
        ...
        $routePrefix = 'pggomediaattachmodule_' . $this->objectTypeLower . '_' . $routeArea;
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'PggoMediaAttachModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'file', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
    ...
    protected function getRedirectUrl($args)
    {
        ...
        if ($this->request->getSession()->has('pggomediaattachmoduleReferer')) {
            $this->request->getSession()->del('pggomediaattachmoduleReferer');
        }
