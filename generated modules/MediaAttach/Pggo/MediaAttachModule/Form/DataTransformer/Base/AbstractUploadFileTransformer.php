...
namespace Pggo\MediaAttachModule\Form\DataTransformer\Base;
...
use Pggo\MediaAttachModule\Form\Type\Field\UploadType;
...
abstract class AbstractUploadFileTransformer implements DataTransformerInterface
{
    ...
    public function reverseTransform($data)
    {
        ...
        if (null === $uploadedFile) {
            // check files array
            $filesKey = 'pggomediaattachmodule_' . $objectType;
