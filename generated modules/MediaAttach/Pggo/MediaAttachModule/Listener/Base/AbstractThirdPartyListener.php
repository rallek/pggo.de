...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function contentGetTypes(\Zikula_Event $event)
    {
        ...
        $types->add('PggoMediaAttachModule_ContentType_Item');
        
        // plugin for showing a list of multiple items
        $types->add('PggoMediaAttachModule_ContentType_ItemList');
    }
     ...
     * PggoMediaAttachModule will use this to add a javascript helper to add custom items.
     *
     * @param \Zikula_Event $event The event instance
     */
    public function getEditorHelpers(\Zikula_Event $event)
    {
        ...
        $helpers->add(
            [
                'module' => 'PggoMediaAttachModule',
                'type'   => 'javascript',
                'path'   => 'modules/Pggo/MediaAttachModule/Resources/public/js/PggoMediaAttachModule.Finder.js'
            ]
        );
    }
    ...
    public function getTinyMcePlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'pggomediaattachmodule',
                'path' => 'modules/Pggo/MediaAttachModule/Resources/docs/scribite/plugins/TinyMce/vendor/tinymce/plugins/pggomediaattachmodule/plugin.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'pggomediaattachmodule',
                'path' => 'modules/Pggo/MediaAttachModule/Resources/docs/scribite/plugins/CKEditor/vendor/ckeditor/plugins/pggomediaattachmodule/',
                'file' => 'plugin.js',
                'img'  => 'ed_pggomediaattachmodule.gif'
            ]
        );
    }
}
