...
abstract class AbstractItem extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('PggoNewsDatesModule detail view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display or link a single PggoNewsDatesModule object.');
    }
    ...
    public function display()
    {
        if (null !== $this->id && !empty($this->displayMode)) {
            return $this->container->get('router')->generate('pggonewsdatesmodule_external_display', $this->getDisplayArguments());
        }
