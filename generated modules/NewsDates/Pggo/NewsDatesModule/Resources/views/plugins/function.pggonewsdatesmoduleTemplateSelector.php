...
/**
 * The pggonewsdatesmoduleTemplateSelector plugin provides items for a dropdown selector.
 *
 ...
 */
function smarty_function_pggonewsdatesmoduleTemplateSelector($params, $view)
{
    $result = [];
