...
namespace Pggo\NewsDatesModule\Form\Plugin\Base;
...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput implements ContainerAwareInterface
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if (!$permissionApi->hasPermission('PggoNewsDatesModule:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }

        $categorisableObjectTypes = ['article', 'event'];
        $catIds = [];
    ...
    {
        parent::decode($view);
        $this->objectType = $this->container->get('request_stack')->getCurrentRequest()->request->get('PggoNewsDatesModule_objecttype', 'article');
        $this->selectedItemId = $this->text;
    }
}
