...
/**
 * Event finder form type base class.
 */
abstract class AbstractEventFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Link to the event') => 1,
                $this->__('ID of event') => 2
            ],
    ...
    {
        return 'pggonewsdatesmodule_eventfinder';
    }
