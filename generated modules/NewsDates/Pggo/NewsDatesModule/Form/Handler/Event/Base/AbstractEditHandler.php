...
namespace Pggo\NewsDatesModule\Form\Handler\Event\Base;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters)
    {
        ...
        if ($this->templateParameters['mode'] == 'create') {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                $this->request->getSession()->getFlashBag()->add('error', $this->__('Sorry, but you can not create the event yet as other items are required which must be created before!'));
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create('Pggo\NewsDatesModule\Form\Type\EventType', $this->entityRef, $options);
    }
    ...
    protected function getRedirectCodes()
    {
        ...
        // user index page of event area
        $codes[] = 'userIndex';
        // admin index page of event area
        $codes[] = 'adminIndex';
        // user list of events
        $codes[] = 'userView';
        ...
        $codes[] = 'adminOwnView';
        // user detail page of treated event
        $codes[] = 'userDisplay';
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'PggoNewsDatesModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'event', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
