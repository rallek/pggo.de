...
namespace Pggo\NewsDatesModule\Form\Handler\Article\Base;
 ...
 * It aims on the article object type.
 */
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters)
    {
        ...
        $this->objectTypeCapital = 'Article';
        $this->objectTypeLower = 'article';
        ...
        if ($this->templateParameters['mode'] == 'create') {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                $this->request->getSession()->getFlashBag()->add('error', $this->__('Sorry, but you can not create the article yet as other items are required which must be created before!'));
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create('Pggo\NewsDatesModule\Form\Type\ArticleType', $this->entityRef, $options);
    }
    ...
    protected function getRedirectCodes()
    {
        ...
        // user index page of article area
        $codes[] = 'userIndex';
        // admin index page of article area
        $codes[] = 'adminIndex';
        ...
        $codes[] = 'adminOwnView';
        // user detail page of treated article
        $codes[] = 'userDisplay';
    ...
    protected function getDefaultMessage($args, $success = false)
    {
        ...
        switch ($args['commandName']) {
            case 'submit':
                if ($this->templateParameters['mode'] == 'create') {
                    $message = $this->__('Done! Article created.');
                } else {
                    $message = $this->__('Done! Article updated.');
                }
                break;
            case 'delete':
                $message = $this->__('Done! Article deleted.');
                break;
            default:
                $message = $this->__('Done! Article updated.');
                break;
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'PggoNewsDatesModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'article', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
