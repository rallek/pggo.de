...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function contentGetTypes(\Zikula_Event $event)
    {
        ...
        $types->add('PggoNewsDatesModule_ContentType_Item');
        
        // plugin for showing a list of multiple items
        $types->add('PggoNewsDatesModule_ContentType_ItemList');
    }
     ...
     * PggoNewsDatesModule will use this to add a javascript helper to add custom items.
     *
     * @param \Zikula_Event $event The event instance
     */
    public function getEditorHelpers(\Zikula_Event $event)
    {
        ...
        $helpers->add(
            [
                ...
                'type'   => 'javascript',
                'path'   => 'modules/Pggo/NewsDatesModule/Resources/public/js/PggoNewsDatesModule.Finder.js'
            ]
        );
    }
    ...
    public function getTinyMcePlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'pggonewsdatesmodule',
                'path' => 'modules/Pggo/NewsDatesModule/Resources/docs/scribite/plugins/TinyMce/vendor/tinymce/plugins/pggonewsdatesmodule/plugin.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'pggonewsdatesmodule',
                'path' => 'modules/Pggo/NewsDatesModule/Resources/docs/scribite/plugins/CKEditor/vendor/ckeditor/plugins/pggonewsdatesmodule/',
                'file' => 'plugin.js',
                'img'  => 'ed_pggonewsdatesmodule.gif'
            ]
        );
    }
}
