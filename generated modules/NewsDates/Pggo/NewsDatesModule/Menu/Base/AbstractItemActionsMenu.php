...
namespace Pggo\NewsDatesModule\Menu\Base;
...
class AbstractItemActionsMenu implements ContainerAwareInterface
{
    ...
    public function menu(FactoryInterface $factory, array $options)
    {
        ...
        if ($entity instanceof ArticleEntity) {
            $component = 'PggoNewsDatesModule:Article:';
            $instance = $entity['id'] . '::';
            $routePrefix = 'pggonewsdatesmodule_article_';
            $isOwner = $currentUserId > 0 && null !== $entity->getCreatedBy() && $currentUserId == $entity->getCreatedBy()->getUid();
        
            if ($routeArea == 'admin') {
                $menu->addChild($this->__('Preview'), [
                    'route' => $routePrefix . 'display',
                    'routeParameters' => ['id' => $entity['id'], 'slug' => $entity['slug']]
            ...
            if ($permissionApi->hasPermission($component, $instance, ACCESS_EDIT)) {
                ...
                $menu[$this->__('Edit')]->setLinkAttribute('title', $this->__('Edit this article'));
                $menu->addChild($this->__('Reuse'), [
                    'route' => $routePrefix . $routeArea . 'edit',
                    'routeParameters' => ['astemplate' => $entity['id'], 'slug' => $entity['slug']]
                ])->setAttribute('icon', 'fa fa-files-o');
                $menu[$this->__('Reuse')]->setLinkAttribute('title', $this->__('Reuse for new article'));
            }
            if ($permissionApi->hasPermission($component, $instance, ACCESS_DELETE)) {
                ...
                $menu[$this->__('Delete')]->setLinkAttribute('title', $this->__('Delete this article'));
            }
            if ($context == 'display') {
            ...
            if ($isOwner || $authAdmin) {
                ...
                $menu->addChild($title, [
                    'route' => 'pggonewsdatesmodule_picture_' . $routeArea . 'edit',
        ...
        if ($entity instanceof PictureEntity) {
            $component = 'PggoNewsDatesModule:Picture:';
            $instance = $entity['id'] . '::';
            $routePrefix = 'pggonewsdatesmodule_picture_';
        ...
        if ($entity instanceof EventEntity) {
            $component = 'PggoNewsDatesModule:Event:';
            $instance = $entity['id'] . '::';
            $routePrefix = 'pggonewsdatesmodule_event_';
            $isOwner = $currentUserId > 0 && null !== $entity->getCreatedBy() && $currentUserId == $entity->getCreatedBy()->getUid();
