...
namespace Pggo\NewsDatesModule\Block\Base;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties)
    {
        ...
        if (!$this->hasPermission('PggoNewsDatesModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        if (in_array($objectType, $this->categorisableObjectTypes)) {
            if ($featureActivationHelper->isEnabled(FeatureActivationHelper::CATEGORIES, $properties['objectType'])) {
                $categoryHelper = $this->get('pggo_newsdates_module.category_helper');
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('PggoNewsDatesModule items');
        }
    ...
    {
        return 'Pggo\NewsDatesModule\Block\Form\Type\ItemListBlockType';
    }
    ...
    {
        return '@PggoNewsDatesModule/Block/itemlist_modify.html.twig';
    }
