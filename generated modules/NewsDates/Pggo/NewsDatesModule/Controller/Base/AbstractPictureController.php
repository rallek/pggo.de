...
abstract class AbstractPictureController extends AbstractController
{
    ...
    protected function viewInternal(Request $request, $sort, $sortdir, $pos, $num, $isAdmin = false)
    {
        ...
        $sortableColumns = new SortableColumns($this->get('router'), 'pggonewsdatesmodule_picture_' . ($isAdmin ? 'admin' : '') . 'view', 'sort', 'sortdir');
    ...
    protected function editInternal(Request $request, $isAdmin = false)
    {
        ...
        $formHandler = $this->get('pggo_newsdates_module.form.handler.picture');
    ...
    protected function deleteInternal(Request $request, PictureEntity $picture, $isAdmin = false)
    {
        ...
        $logArgs = ['app' => 'PggoNewsDatesModule', 'user' => $this->get('zikula_users_module.current_user')->get('uname'), 'entity' => 'picture', 'id' => $picture->createCompositeIdentifier()];
        ...
        $redirectRoute = 'pggonewsdatesmodule_picture_' . ($isAdmin ? 'admin' : '') . 'view';
        ...
        $form = $this->createForm('Pggo\NewsDatesModule\Form\DeleteEntityType', $picture);
    ...
    protected function indexInternal(Request $request, $isAdmin = false)
    {
        ...
        return $this->redirectToRoute('pggonewsdatesmodule_picture_' . $templateParameters['routeArea'] . 'view');
        
        // return index template
        return $this->render('@PggoNewsDatesModule/Picture/index.html.twig', $templateParameters);
    }
    ...
    protected function handleSelectedEntriesActionInternal(Request $request, $isAdmin = false)
    {
        ...
        foreach ($items as $itemid) {
            ...
            try {
                ...
                $logger->error('{app}: User {user} tried to execute the {action} workflow action for the {entity} with id {id}, but failed. Error details: {errorMessage}.', ['app' => 'PggoNewsDatesModule', 'user' => $userName, 'action' => $action, 'entity' => 'picture', 'id' => $itemid, 'errorMessage' => $e->getMessage()]);
            }
            ...
            if ($action == 'delete') {
                $this->addFlash('status', $this->__('Done! Item deleted.'));
                $logger->notice('{app}: User {user} deleted the {entity} with id {id}.', ['app' => 'PggoNewsDatesModule', 'user' => $userName, 'entity' => 'picture', 'id' => $itemid]);
            } else {
                $this->addFlash('status', $this->__('Done! Item updated.'));
                $logger->notice('{app}: User {user} executed the {action} workflow action for the {entity} with id {id}.', ['app' => 'PggoNewsDatesModule', 'user' => $userName, 'action' => $action, 'entity' => 'picture', 'id' => $itemid]);
            }
        }
        
        return $this->redirectToRoute('pggonewsdatesmodule_picture_' . ($isAdmin ? 'admin' : '') . 'index');
    }
}
