...
abstract class AbstractConfigController extends AbstractController
{
    ...
    public function configAction(Request $request)
    {
        ...
        $form = $this->createForm('Pggo\NewsDatesModule\Form\AppSettingsType');
        ...
        if ($form->handleRequest($request)->isValid()) {
            if ($form->get('save')->isClicked()) {
                ...
                $this->get('logger')->notice('{app}: User {user} updated the configuration.', ['app' => 'PggoNewsDatesModule', 'user' => $userName]);
            } elseif ($form->get('cancel')->isClicked()) {
                $this->addFlash('status', $this->__('Operation cancelled.'));
            }
        
            // redirect to config page again (to show with GET request)
            return $this->redirectToRoute('pggonewsdatesmodule_config_config');
        }
        ...
        return $this->render('@PggoNewsDatesModule/Config/config.html.twig', $templateParameters);
    }
}
