...
namespace Pggo\NewsDatesModule\Traits;
...
trait EntityWorkflowTrait
{
    ...
    {
        $entityClass = 'PggoNewsDatesModule:' . ucfirst($this->get_objectType()) . 'Entity';
    ...
    public function initWorkflow($forceLoading = false)
    {
        ...
        $workflowHelper = $container->get('pggo_newsdates_module.workflow_helper');
        ...
        if (($loadingRequired && !$isReuse) || $forceLoading) {
            $result = Zikula_Workflow_Util::getWorkflowForObject($this, $objectType, $idColumn, 'PggoNewsDatesModule');
            if (!$result) {
    ...
    public function resetWorkflow()
    {
        ...
        $workflowHelper = ServiceUtil::get('pggo_newsdates_module.workflow_helper');
