...
abstract class AbstractSelectionHelper
{
     ...
     */
    public function __construct(TranslatorInterface $translator, NewsDatesFactory $entityFactory)
    {
    ...
    public function getIdFields($objectType = '')
    {
        ...
        $entityClass = 'PggoNewsDatesModule:' . ucfirst($objectType) . 'Entity';
     ...
     */
    public function getEntity($objectType = '', $id = '', $slug = '', $useJoins = true, $slimMode = false)
    {
        if (empty($objectType)) {
            throw new InvalidArgumentException($this->translator->__('Invalid object type received.'));
        }
