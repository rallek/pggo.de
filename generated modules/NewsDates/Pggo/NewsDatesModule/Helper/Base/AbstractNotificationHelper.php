...
abstract class AbstractNotificationHelper
{
    ...
    protected function sendMails()
    {
        ...
        foreach ($this->recipients as $recipient) {
            ...
            $body = $this->templating->render('@PggoNewsDatesModule/' . $template, $templateParameters);
            $altBody = '';
            $html = true;
    ...
    protected function prepareEmailData()
    {
        ...
        $hasDisplayAction = in_array($objectType, ['article', 'event']);
        $hasEditAction = in_array($objectType, ['article', 'picture', 'event']);
        $routeArea = in_array($this->recipientType, ['moderator', 'superModerator']) ? 'admin' : '';
        $routePrefix = 'pggonewsdatesmodule_' . strtolower($objectType) . '_' . $routeArea;
