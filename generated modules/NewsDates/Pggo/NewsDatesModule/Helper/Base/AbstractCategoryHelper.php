...
abstract class AbstractCategoryHelper
{
    ...
    /**
     * Retrieves the main/default category of PggoNewsDatesModule.
     *
    ...
    public function getMainCat($objectType = '', $registry = '')
    {
        ...
        $logArgs = ['app' => 'PggoNewsDatesModule', 'user' => $this->currentUserApi->get('uname')];
        $this->logger->warning('{app}: User {user} called CategoryHelper#getMainCat which is deprecated.', $logArgs);
    
        return $this->categoryRegistryApi->getModuleCategoryId('PggoNewsDatesModule', ucfirst($objectType) . 'Entity', $registry, 32); // 32 == /__System/Modules/Global
    }
    ...
    public function retrieveCategoriesFromRequest($objectType = '', $source = 'POST')
    {
        ...
        $inputValues = null;
        $inputName = 'pggonewsdatesmodule_' . strtolower($objectType) . 'quicknav';
        if (!$dataSource->has($inputName)) {
            $inputName = 'pggonewsdatesmodule_' . strtolower($objectType) . 'finder';
        }
        if ($dataSource->has($inputName)) {
    ...
    public function getAllProperties($objectType = '')
    {
        ...
        return $this->categoryRegistryApi->getModuleRegistriesIds('PggoNewsDatesModule', ucfirst($objectType) . 'Entity');
    }
    ...
    public function getAllPropertiesWithMainCat($objectType = '', $arrayKey = '')
    {
        ...
        return $this->categoryRegistryApi->getModuleCategoryIds('PggoNewsDatesModule', ucfirst($objectType) . 'Entity', $arrayKey);
    }
    ...
    public function getMainCatForProperty($objectType = '', $property = '')
    {
        ...
        return $this->categoryRegistryApi->getModuleCategoryId('PggoNewsDatesModule', ucfirst($objectType) . 'Entity', $property);
    }
