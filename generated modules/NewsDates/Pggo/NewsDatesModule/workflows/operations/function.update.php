 ...
 */
function PggoNewsDatesModule_operation_update(&$entity, $params)
{
    ...
    $logArgs = ['app' => 'PggoNewsDatesModule', 'user' => $container->get('zikula_users_module.current_user')->get('uname')];
