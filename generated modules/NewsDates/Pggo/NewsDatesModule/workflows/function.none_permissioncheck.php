 ...
 */
function PggoNewsDatesModule_workflow_none_permissioncheck($obj, $permLevel, $currentUser, $actionId)
{
 ...
 */
function PggoNewsDatesModule_workflow_none_gettextstrings()
{
