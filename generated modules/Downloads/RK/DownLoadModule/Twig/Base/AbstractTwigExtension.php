...
namespace RK\DownLoadModule\Twig\Base;
...
abstract class AbstractTwigExtension extends Twig_Extension
{
    ...
    /**
     * The rkdownloadmodule_objectState filter displays the name of a given object's workflow state.
     * Examples:
     *    {{ item.workflowState|rkdownloadmodule_objectState }}        {# with visual feedback #}
     *    {{ item.workflowState|rkdownloadmodule_objectState(false) }} {# no ui feedback #}
     *
    ...
    /**
     * The rkdownloadmodule_listEntry filter displays the name
     * or names for a given list item.
     * Example:
     *     {{ entity.listField|rkdownloadmodule_listEntry('entityName', 'fieldName') }}
     *
    ...
    /**
     * The rkdownloadmodule_objectTypeSelector function provides items for a dropdown selector.
     *
    ...
    /**
     * The rkdownloadmodule_templateSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    public function getUserAvatar($uid = 0, $width = 0, $height = 0, $size = 0, $rating = '')
    {
        ...
        $view = \Zikula_View::getInstance('RKDownLoadModule');
