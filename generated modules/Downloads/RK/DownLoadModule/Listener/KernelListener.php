...
class KernelListener extends AbstractKernelListener
{
    ...
    public function onRequest(GetResponseEvent $event)
    {
        ...
        // $testMessage = 'Hello from down load app';
        // $event->getRequest()->attributes->set('RKDownLoadModule_test', $testMessage);
    ...
    public function onResponse(FilterResponseEvent $event)
    {
        ...
        // $testMessage = $event->getRequest()->attributes->get('RKDownLoadModule_test');
        // now $testMessage should be: 'Hello from down load app'
    ...
    public function onException(GetResponseForExceptionEvent $event)
    {
        ...
        //     || $exception instanceof MySpecialExceptionInterface) {
            ...
            // $message = sprintf(
            //     'down load App Error says: %s with code: %s',
