...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function contentGetTypes(\Zikula_Event $event)
    {
        ...
        $types->add('RKDownLoadModule_ContentType_Item');
        
        // plugin for showing a list of multiple items
        $types->add('RKDownLoadModule_ContentType_ItemList');
    }
     ...
     * RKDownLoadModule will use this to add a javascript helper to add custom items.
     *
     * @param \Zikula_Event $event The event instance
     */
    public function getEditorHelpers(\Zikula_Event $event)
    {
        ...
        $helpers->add(
            [
                ...
                'type'   => 'javascript',
                'path'   => 'modules/RK/DownLoadModule/Resources/public/js/RKDownLoadModule.Finder.js'
            ]
        );
    }
    ...
    public function getTinyMcePlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rkdownloadmodule',
                'path' => 'modules/RK/DownLoadModule/Resources/docs/scribite/plugins/TinyMce/vendor/tinymce/plugins/rkdownloadmodule/plugin.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rkdownloadmodule',
                'path' => 'modules/RK/DownLoadModule/Resources/docs/scribite/plugins/CKEditor/vendor/ckeditor/plugins/rkdownloadmodule/',
                'file' => 'plugin.js',
                'img'  => 'ed_rkdownloadmodule.gif'
            ]
        );
    }
}
