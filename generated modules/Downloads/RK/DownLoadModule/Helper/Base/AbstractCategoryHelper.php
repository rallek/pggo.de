...
abstract class AbstractCategoryHelper
{
    ...
    public function getMainCat($objectType = '', $registry = '')
    {
        ...
        return $this->categoryRegistryApi->getModuleCategoryId('RKDownLoadModule', ucfirst($objectType) . 'Entity', $registry, 32); // 32 == /__System/Modules/Global
    }
    ...
    public function getAllProperties($objectType = '')
    {
        ...
        return $this->categoryRegistryApi->getModuleRegistriesIds('RKDownLoadModule', ucfirst($objectType) . 'Entity');
    }
    ...
    public function getAllPropertiesWithMainCat($objectType = '', $arrayKey = '')
    {
        ...
        return $this->categoryRegistryApi->getModuleCategoryIds('RKDownLoadModule', ucfirst($objectType) . 'Entity', $arrayKey);
    }
    ...
    public function getMainCatForProperty($objectType = '', $property = '')
    {
        ...
        return $this->categoryRegistryApi->getModuleCategoryId('RKDownLoadModule', ucfirst($objectType) . 'Entity', $property);
    }
