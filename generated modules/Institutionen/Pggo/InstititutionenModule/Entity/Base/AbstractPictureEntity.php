...
abstract class AbstractPictureEntity extends EntityAccess
{
    ...
    /**
     * Bidirectional - Many pictures [pictures] are linked by one institution [institution] (OWNING SIDE).
     *
     * @ORM\ManyToOne(targetEntity="Pggo\InstititutionenModule\Entity\InstitutionEntity", inversedBy="pictures")
     * @ORM\JoinTable(name="pggo_instit_institution")
     * @Assert\Type(type="Pggo\InstititutionenModule\Entity\InstitutionEntity")
     * @var \Pggo\InstititutionenModule\Entity\InstitutionEntity $institution
     */
     ...
     *
     * @param \Pggo\InstititutionenModule\Entity\InstitutionEntity $institution
     *
     * @return void
     */
    ...
    {
        return 'pggoinstititutionenmodule.ui_hooks.pictures';
    }
