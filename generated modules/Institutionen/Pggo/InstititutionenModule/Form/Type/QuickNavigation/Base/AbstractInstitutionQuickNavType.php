...
namespace Pggo\InstititutionenModule\Form\Type\QuickNavigation\Base;
...
/**
 * Institution quick navigation form type base class.
 */
abstract class AbstractInstitutionQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    * @param RequestStack        $requestStack RequestStack service instance
    ...
    {
        $listEntries = $this->listHelper->getEntries('institution', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'pggoinstititutionenmodule_institutionquicknav';
    }
}
