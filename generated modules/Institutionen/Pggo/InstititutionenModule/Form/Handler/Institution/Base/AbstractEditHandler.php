...
namespace Pggo\InstititutionenModule\Form\Handler\Institution\Base;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    {
        $this->objectType = 'institution';
        $this->objectTypeCapital = 'Institution';
        $this->objectTypeLower = 'institution';
        ...
        if ($this->templateParameters['mode'] == 'create') {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                $this->request->getSession()->getFlashBag()->add('error', $this->__('Sorry, but you can not create the institution yet as other items are required which must be created before!'));
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create('Pggo\InstititutionenModule\Form\Type\InstitutionType', $this->entityRef, $options);
    }
    ...
    protected function getRedirectCodes()
    {
        ...
        // user index page of institution area
        $codes[] = 'userIndex';
        // admin index page of institution area
        $codes[] = 'adminIndex';
        ...
        $codes[] = 'adminOwnView';
        // user detail page of treated institution
        $codes[] = 'userDisplay';
    ...
    protected function getDefaultReturnUrl($args)
    {
        ...
        // redirect to the list of institutions
        $viewArgs = [];
    ...
    protected function getDefaultMessage($args, $success = false)
    {
        ...
        switch ($args['commandName']) {
            ...
            case 'submit':
                if ($this->templateParameters['mode'] == 'create') {
                    $message = $this->__('Done! Institution created.');
                } else {
                    $message = $this->__('Done! Institution updated.');
                }
                break;
            case 'delete':
                $message = $this->__('Done! Institution deleted.');
                break;
            default:
                $message = $this->__('Done! Institution updated.');
                break;
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'PggoInstititutionenModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'institution', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
