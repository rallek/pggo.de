...
abstract class AbstractExternalController extends AbstractController
{
    ...
    public function finderAction(Request $request, $objectType, $editor, $sort, $sortdir, $pos = 1, $num = 0)
    {
        ...
        if (!$this->hasPermission('PggoInstititutionenModule:' . ucfirst($objectType) . ':', '::', ACCESS_COMMENT)) {
        ...
        $form = $this->createForm('Pggo\InstititutionenModule\Form\Type\Finder\\' . ucfirst($objectType) . 'FinderType', $templateParameters, $formOptions);
        ...
        $output = $this->renderView('@PggoInstititutionenModule/External/' . ucfirst($objectType) . '/find.html.twig', $templateParameters);
