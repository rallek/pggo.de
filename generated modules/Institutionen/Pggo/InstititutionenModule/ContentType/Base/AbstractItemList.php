...
abstract class AbstractItemList extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('PggoInstititutionenModule list view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display list of PggoInstititutionenModule objects.');
    }
    ...
    protected function getDisplayTemplate()
    {
        ...
        foreach ($templateOptions as $templatePath) {
            if ($templating->exists('@PggoInstititutionenModule/' . $templatePath)) {
                $template = '@PggoInstititutionenModule/' . $templatePath;
                break;
            }
        }
