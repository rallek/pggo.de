...
namespace Pggo\InstititutionenModule\ContentType\Base;
...
abstract class AbstractItem extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return 'PggoInstititutionenModule';
    }
    ...
    {
        return $this->container->get('translator.default')->__('PggoInstititutionenModule detail view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display or link a single PggoInstititutionenModule object.');
    }
    ...
    {
        $controllerHelper = $this->container->get('pggo_instititutionen_module.controller_helper');
    ...
    public function display()
    {
        ...
        $controllerReference = new ControllerReference('PggoInstititutionenModule:External:display', $this->getDisplayArguments());
    ...
    public function startEditing()
    {
        ...
        $this->view->toplevelmodule = 'PggoInstititutionenModule';
