...
abstract class AbstractSelectionHelper
{
     ...
     */
    public function __construct(TranslatorInterface $translator, InstititutionenFactory $entityFactory)
    {
    ...
    public function getIdFields($objectType = '')
    {
        ...
        $entityClass = 'PggoInstititutionenModule:' . ucfirst($objectType) . 'Entity';
