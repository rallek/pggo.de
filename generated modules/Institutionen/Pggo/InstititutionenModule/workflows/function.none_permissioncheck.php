 ...
 */
function PggoInstititutionenModule_workflow_none_permissioncheck($obj, $permLevel, $currentUser, $actionId)
{
 ...
 */
function PggoInstititutionenModule_workflow_none_gettextstrings()
{
