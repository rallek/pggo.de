...
abstract class AbstractUserListener implements EventSubscriberInterface
{
     ...
     * @return void
     */
    public function __construct(TranslatorInterface $translator, TeamFactory $entityFactory, CurrentUserApi $currentUserApi, LoggerInterface $logger)
    {
    ...
    public function delete(GenericEvent $event)
    {
        ...
        $repo = $this->entityFactory->getRepository('person');
        // set creator to admin (2) for all persons created by this user
        $repo->updateCreator($userId, 2, $this->translator, $this->logger, $this->currentUserApi);
        
        // set last editor to admin (2) for all persons updated by this user
        $repo->updateLastEditor($userId, 2, $this->translator, $this->logger, $this->currentUserApi);
        
        $logArgs = ['app' => 'PggoTeamModule', 'user' => $this->currentUserApi->get('uname'), 'entities' => 'persons'];
