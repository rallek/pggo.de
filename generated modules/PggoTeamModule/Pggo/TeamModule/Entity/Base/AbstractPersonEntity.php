...
abstract class AbstractPersonEntity extends EntityAccess
{
    ...
    /**
     * will be shown inside the list view and in the detail view
    ...
    /**
     * will be shown only in the detail view
     * @ORM\Column(type="text", length=2000)
     * @Assert\NotNull()
     * @Assert\Length(min="0", max="2000")
     ...
     * @Assert\NotBlank()
     * @Assert\Length(min="0", max="255")
     * @var string $functionRole
     */
    protected $functionRole = '';
    ...
    /**
     * address, phone numers and so on
     * @ORM\Column(type="text", length=2000)
     * @Assert\NotNull()
     * @Assert\Length(min="0", max="2000")
     * @var text $contact
    ...
    /**
     * @ORM\OneToMany(targetEntity="\Pggo\TeamModule\Entity\PersonCategoryEntity", 
     *                mappedBy="entity", cascade={"all"}, 
     *                orphanRemoval=true)
     * @var \Pggo\TeamModule\Entity\PersonCategoryEntity
     */
    ...
    /**
     * Returns the function role.
     *
     * @return string
     */
    public function getFunctionRole()
    {
        return $this->functionRole;
    }
    
    /**
     * Sets the function role.
     *
     * @param string $functionRole
     *
     * @return void
     */
    public function setFunctionRole($functionRole)
    {
        $this->functionRole = isset($functionRole) ? $functionRole : '';
    }
    ...
    {
        $this->emailAddress = isset($emailAddress) ? $emailAddress : '';
    }
    ...
    {
        $this->contact = isset($contact) ? $contact : '';
    }
     ...
     * @param \Pggo\TeamModule\Entity\PersonCategoryEntity $element
     *
     * @return bool|int
     */
    private function collectionContains(ArrayCollection $collection, \Pggo\TeamModule\Entity\PersonCategoryEntity $element)
    {
        foreach ($collection as $key => $category) {
            /** @var \Pggo\TeamModule\Entity\PersonCategoryEntity $category */
    ...
    {
        $listHelper = ServiceUtil::get('pggo_team_module.listentries_helper');
    ...
    public static function getWorkflowStateAllowedValues()
    {
        ...
        $helper = $container->get('pggo_team_module.listentries_helper');
    ...
    {
        return 'pggoteammodule.ui_hooks.persons';
    }
