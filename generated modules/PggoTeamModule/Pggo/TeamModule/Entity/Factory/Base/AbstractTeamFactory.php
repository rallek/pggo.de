...
namespace Pggo\TeamModule\Entity\Factory\Base;
...
abstract class AbstractTeamFactory
{
    ...
    {
        $entityClass = 'Pggo\\TeamModule\\Entity\\' . ucfirst($objectType) . 'Entity';
     ...
     *
     * @return Pggo\TeamModule\Entity\personEntity The newly created entity instance
     */
