...
abstract class AbstractCategoryHelper
{
    ...
    /**
     * Retrieves the main/default category of PggoTeamModule.
     *
    ...
    public function getMainCat($objectType = '', $registry = '')
    {
        ...
        $logArgs = ['app' => 'PggoTeamModule', 'user' => $this->currentUserApi->get('uname')];
        $this->logger->warning('{app}: User {user} called CategoryHelper#getMainCat which is deprecated.', $logArgs);
    
        return $this->categoryRegistryApi->getModuleCategoryId('PggoTeamModule', ucfirst($objectType) . 'Entity', $registry, 32); // 32 == /__System/Modules/Global
    }
    ...
    public function retrieveCategoriesFromRequest($objectType = '', $source = 'POST')
    {
        ...
        $inputValues = null;
        $inputName = 'pggoteammodule_' . strtolower($objectType) . 'quicknav';
        if (!$dataSource->has($inputName)) {
            $inputName = 'pggoteammodule_' . strtolower($objectType) . 'finder';
        }
        if ($dataSource->has($inputName)) {
    ...
    public function getAllProperties($objectType = '')
    {
        ...
        return $this->categoryRegistryApi->getModuleRegistriesIds('PggoTeamModule', ucfirst($objectType) . 'Entity');
    }
    ...
    public function getAllPropertiesWithMainCat($objectType = '', $arrayKey = '')
    {
        ...
        return $this->categoryRegistryApi->getModuleCategoryIds('PggoTeamModule', ucfirst($objectType) . 'Entity', $arrayKey);
    }
    ...
    public function getMainCatForProperty($objectType = '', $property = '')
    {
        ...
        return $this->categoryRegistryApi->getModuleCategoryId('PggoTeamModule', ucfirst($objectType) . 'Entity', $property);
    }
