 ...
 */
function PggoTeamModule_workflow_none_permissioncheck($obj, $permLevel, $currentUser, $actionId)
{
    // calculate the permission component
    $objectType = $obj['_objectType'];
    $component = 'PggoTeamModule:' . ucfirst($objectType) . ':';
 ...
 */
function PggoTeamModule_workflow_none_gettextstrings()
{
