...
namespace Pggo\TeamModule\Twig\Base;
...
use Pggo\TeamModule\Helper\WorkflowHelper;
...
abstract class AbstractTwigExtension extends Twig_Extension
{
    ...
    {
        return [
            new \Twig_SimpleFunction('pggoteammodule_objectTypeSelector', [$this, 'getObjectTypeSelector']),
            new \Twig_SimpleFunction('pggoteammodule_templateSelector', [$this, 'getTemplateSelector']),
            new \Twig_SimpleFunction('pggoteammodule_userAvatar', [$this, 'getUserAvatar'], ['is_safe' => ['html']])
        ];
    }
    ...
    {
        return [
            new \Twig_SimpleFilter('pggoteammodule_fileSize', [$this, 'getFileSize'], ['is_safe' => ['html']]),
            new \Twig_SimpleFilter('pggoteammodule_listEntry', [$this, 'getListEntry']),
            new \Twig_SimpleFilter('pggoteammodule_objectState', [$this, 'getObjectState'], ['is_safe' => ['html']])
        ];
    }
    
    /**
     * The pggoteammodule_objectState filter displays the name of a given object's workflow state.
     * Examples:
     *    {{ item.workflowState|pggoteammodule_objectState }}        {# with visual feedback #}
     *    {{ item.workflowState|pggoteammodule_objectState(false) }} {# no ui feedback #}
     *
    ...
    /**
     * The pggoteammodule_fileSize filter displays the size of a given file in a readable way.
     * Example:
     *     {{ 12345|pggoteammodule_fileSize }}
     *
    ...
    /**
     * The pggoteammodule_listEntry filter displays the name
     * or names for a given list item.
     * Example:
     *     {{ entity.listField|pggoteammodule_listEntry('entityName', 'fieldName') }}
     *
    ...
    /**
     * The pggoteammodule_objectTypeSelector function provides items for a dropdown selector.
     *
    ...
    /**
     * The pggoteammodule_templateSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    public function getUserAvatar($uid = 0, $width = 0, $height = 0, $size = 0, $rating = '')
    {
        ...
        $view = \Zikula_View::getInstance('PggoTeamModule');
