...
namespace Pggo\TeamModule\Block\Base;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function __construct(AbstractBundle $bundle)
    {
        ...
        $this->categorisableObjectTypes = ['person'];
    }
    ...
    public function display(array $properties)
    {
        ...
        if (!$this->hasPermission('PggoTeamModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        $repository = $this->get('pggo_team_module.entity_factory')->getRepository($objectType);
        ...
        if (in_array($objectType, $this->categorisableObjectTypes)) {
            if ($featureActivationHelper->isEnabled(FeatureActivationHelper::CATEGORIES, $properties['objectType'])) {
                $categoryHelper = $this->get('pggo_team_module.category_helper');
        ...
        if ($featureActivationHelper->isEnabled(FeatureActivationHelper::CATEGORIES, $objectType)) {
            $entities = $this->get('pggo_team_module.category_helper')->filterEntitiesByPermission($entities);
        }
    
        // set a block title
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('PggoTeamModule items');
        }
        ...
        $imageHelper = $this->get('pggo_team_module.image_helper');
    ...
    {
        return 'Pggo\TeamModule\Block\Form\Type\ItemListBlockType';
    }
    ...
    {
        return '@PggoTeamModule/Block/itemlist_modify.html.twig';
    }
